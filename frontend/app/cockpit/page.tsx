    ...
    return (
        <div className="h-[calc(100vh-140px)] -m-6">
            <CockpitShell
                ...
                className={cn(viewMode === 'PILOT' ? 'bg-black' : '', "h-full")}
            >
                {/* Coach Debrief Overlay */}
                {showDebrief && (
                    <div className="fixed inset-0 z-[100] bg-black/95 backdrop-blur-xl p-8 animate-fade-in">
                ...
                <div className="flex flex-col h-full gap-6">
                    ...
                    {/* Cockpit Toolbar / Mode Toggle */}
                    <div className="flex items-center justify-between bg-white/5 border border-white/10 p-4 rounded-xl backdrop-blur-md">
                        <div className="flex items-center gap-4">
                            <div className="px-3 py-1.5 rounded bg-white/10 text-[10px] items-center flex gap-2 text-white/50 border border-white/5 font-mono">
                                <div className={cn("w-2 h-2 rounded-full", viewMode === 'PILOT' ? "bg-blue-400 shadow-[0_0_8px_rgba(96,165,250,0.5)]" : "bg-purple-500 shadow-[0_0_8px_rgba(168,85,247,0.5)]")}></div>
                                {viewMode} MODE
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-12 gap-6 flex-1 min-h-0 overflow-y-auto pr-2 custom-scrollbar">
                            ...
                            <div className="flex-1 rounded-xl border border-white/10 bg-black/40 backdrop-blur-sm relative overflow-hidden group min-h-[400px] flex flex-col">
                                ...
                                <div className="flex-1 relative">
                                    {viewMode === 'ENGINEER' ? (
                                        ...
                                        <div className="p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 overflow-y-auto h-full">
                        ...
                        {viewMode === 'ENGINEER' && (
                            <div className="col-span-3 flex flex-col gap-4 animate-fade-in pr-2 overflow-y-auto custom-scrollbar">
...
export default function CockpitPage() {
    return (
        <DashboardLayout title="ALPHA COCKPIT" subtitle="NEURAL_HUD_ACTIVE" icon={TerminalIcon}>
            <CockpitContent />
        </DashboardLayout>
    );
}
